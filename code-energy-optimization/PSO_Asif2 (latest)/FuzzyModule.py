...
def FuzzyControl(Optimal_Temp, Optimal_Humid, index, simulationsCheck, figPath = "results/", figFilePre = "", exp=""):
    ...
    if (index > simulationsCheck):
    	temperature['average temp'].view()
    	plt.savefig(figPath+figFilePre+"avg-temp.png")

    	Control_Temp.view()
    	plt.savefig(figPath+figFilePre+"ctrl-temp-1.png")

    	humidity['average humid'].view()
    	plt.savefig(figPath+figFilePre+"avg-humid.png")

    	Control_Humid.view()
    	plt.savefig(figPath+figFilePre+"ctrl-humid-1.png")
    ...
    if (index > simulationsCheck):
    	...
    	plt.savefig(figPath+figFilePre+"ctrl-temp-2.png")

    	Control_Humid.view(sim=HumidControlling)
    	plt.savefig(figPath+figFilePre+"ctrl-humid-2.png")
