...
print("\nGoing to setup matplotlib figure opening limit '{:}'".format(
	"max_open_warning = 0"
))
mpl.rc('figure', max_open_warning = 0)
# mpl.rcParams.update({'figure.max_open_warning': 0})
print("Successfully setup matplotlib figure opening limit\n")
...
sim = 1000        # set simulation iterations
for index in range (0,sim):
    print("/n")
    print("-------------- Simulation iteration : "+str(index+1)+" -----------------")
    ...
    FuzzyTemp, FuzzyHumid = FuzzyControl(pos_best_g[0], pos_best_g[1], index)
